...
let add_exchange ex = a_exchange ex |- u_last_action (Exchange ex)
let add_client_s    = a_client_s    |- u_last_action (Key S      )
let add_client_e    = a_client_e    |- u_last_action (Key E      )
let add_server_s    = a_server_s    |- u_last_action (Key S      )
let add_server_e    = a_server_e    |- u_last_action (Key E      )
